...
import { subscribeToAllMatches, submitMatch, flagMatch, deleteMatch, updateMatchData } from '@/lib/firestore';
...
export function useMatches() {
  ...
  return { matches, loading, submit, flag, deleteEntry, updateEntry };
}
